...
A publication of data of type rti::shapes::ShapeType
...
Example publication of type rti::shapes::ShapeType automatically generated by
...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    rti::shapes::ShapeTypeDataWriter * ShapeType_writer = NULL;
    ReturnCode_t retcode;
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("Writing rti::shapes::ShapeType, count %d\n", count);

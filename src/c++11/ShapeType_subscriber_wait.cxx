...
int subscriber_main(int domain_id, int sample_count)
{
    ...
    {
        // Take all samples
        dds::sub::LoanedSamples<rti::shapes::ShapeType> samples = reader.take();
    ...
    while (count < sample_count || sample_count == 0) {
        ...
        // when they activate
        std::cout << "rti::shapes::ShapeType subscriber sleeping for 4 sec..." << std::endl;
